                            ...
                            <form class="form-horizontal" method="post" action="" name="formJoin" id="formJoin" onSubmit="return checkForm();">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <!-- <input type="password" class="form-control" name="m_passwd" placeholder="密碼*" value="<?php echo $row_RecMember["m_passwd"];?>" /> -->
                                        ...
                                        <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="m_sex" value="男" <?php if($row_RecMember["m_sex"]=="男") echo "checked";?>>
                                                    <span> Male </span> 
                                                </label>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="m_sex" value="女" <?php if($row_RecMember["m_sex"]=="女") echo "checked";?>>
                                                    <span>Female </span> 
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="email" class="form-control" name="m_email" placeholder="信箱 *" value="<?php echo $row_RecMember["m_email"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="m_birthday" placeholder="生日*" value="<?php echo $row_RecMember["m_birthday"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="m_address" placeholder="地址" value="<?php echo $row_RecMember["m_address"];?>" />
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="m_phone" placeholder="電話" value="<?php echo $row_RecMember["m_phone"];?>" />
                                        </div>
